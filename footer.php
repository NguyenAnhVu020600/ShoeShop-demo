            ...
            <ul class="shoes-gp">
                <li>
                    <div class="gallery_item">
                        <img class="img-resize" src="img/shoes/gallery_item_1.jpg" alt="">
                    </div>
                </li>
                <li>
                    <div class="gallery_item">
                        <img class="img-resize" src="img/shoes/gallery_item_2.jpg" alt="">
                    </div>
                </li>
                <li>
                    <div class="gallery_item">
                        <img class="img-resize" src="img/shoes/gallery_item_3.jpg" alt="">
                    </div>
                </li>
                <li>
                    <div class="gallery_item">
                        <img class="img-resize" src="img/shoes/gallery_item_4.jpg" alt="">
                    </div>
                </li>
                <li>
                    <div class="gallery_item">
                        <img class="img-resize" src="img/shoes/gallery_item_5.jpg" alt="">
                    </div>
                </li>
                <li>
                    <div class="gallery_item">
                        <img class="img-resize" src="img/shoes/gallery_item_6.jpg" alt="">
                    </div>
                </li>
            </ul>
        </div>
                    ...
                    <div class="footer-col footer-block">
                        ...
                        <div class="footer-content">
                            ...
                            <div class="logo-footer">
                                <img src="img/logo-bct.png" alt="Bộ Công Thương">
                            </div>
