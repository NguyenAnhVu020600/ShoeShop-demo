...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 19, 2022 lúc 03:10 PM
...
INSERT INTO `admin` (`id_ad`, `username`, `email`, `password`, `phone`, `province`, `district`, `address`, `role`) VALUES
(1, 'Nguyễn Anh Vũ', 'admin@gmail.com', '12345', '0362612183', 56, 568, '22 Lê Đại Hành', 'admin'),
(2, 'Võ Thanh Hiếu        ', 'nhanvien2@gmail.com', '12345', '0365426635', 56, 571, '15 Thống Nhất', 'enployee'),
(3, 'Phan Quang Vinh ', 'nhanvien3@gmail.com', '12345', '0352146958', 56, 568, '55 Lê Hồng Phong', 'shipper');
...
INSERT INTO `color` (`id_color`, `color`, `id_product`) VALUES
(1, 'Trắng/Xanh', 1),
(2, 'Xanh', 2),
(3, 'Xanh', 3),
(4, 'Xám', 3),
...
INSERT INTO `district` (`id_district`, `name`, `type`, `id_province`) VALUES
...
CREATE TABLE `orders` (
  ...
  `nv_duyet` int(10) NOT NULL,
  `nv_giao` int(10) NOT NULL,
...
INSERT INTO `orders` (`id_order`, `id_user`, `id_product`, `size`, `color`, `quantity`, `province`, `district`, `address`, `orderdate`, `transport_date`, `nv_duyet`, `nv_giao`, `status`) VALUES
(1, 1, 1, '40', 'Trắng/Xanh', 2, 56, 568, '22 Lê Đại Hành', '2022-01-14 22:55:57', '2022-01-19 00:34:47', 1, 3, 'paid'),
(47, 1, 1, '39', 'Trắng/Xanh', 2, 1, 2, '22 Lê Đại Hành', '2022-01-15 23:16:36', '0000-00-00 00:00:00', 2, 3, 'ordered'),
(49, 1, 1, '39', 'Trắng/Xanh', 1, 1, 2, '22 Lê Đại Hành', '2022-01-15 23:16:36', '0000-00-00 00:00:00', 1, 3, 'ordered'),
(63, 1, 1, '39', 'Trắng/Xanh', 2, 56, 568, '07 HaRa', '2022-01-19 00:34:47', '0000-00-00 00:00:00', 2, 3, 'ordered'),
(69, 2, 1, '41', 'Trắng/Xanh', 1, 56, 568, '07 HaRa', '2022-01-19 00:34:47', '0000-00-00 00:00:00', 2, 3, 'paid'),
(70, 2, 1, '42', 'Trắng/Xanh', 1, 56, 568, '07 HaRa', '2022-01-19 00:34:47', '0000-00-00 00:00:00', 1, 3, 'transport'),
(71, 1, 6, '39', 'Xám', 1, 56, 572, '07 HaRa', '2022-01-19 17:27:37', '0000-00-00 00:00:00', 0, 0, 'ordered'),
(72, 2, 2, '40', 'Xanh', 2, 56, 572, '07 HaRa', '2022-01-19 17:27:37', '2022-01-22 00:00:00', 2, 3, 'paid'),
(73, 1, 2, '39', 'Xanh', 1, 56, 568, '22 Lê Đại Hành', '2022-01-19 17:31:12', '2022-01-22 00:00:00', 2, 3, 'paid');
...
CREATE TABLE `order_details` (
  ...
  `ptvc` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `order_details` (`id_order`, `id_product`, `quantity`, `pttt`, `ptvc`, `status`) VALUES
(47, 1, 2, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(49, 1, 1, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(63, 1, 2, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(69, 1, 1, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(70, 1, 1, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(71, 6, 1, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(72, 2, 1, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish'),
(73, 2, 1, 'Thanh toán khi nhận hàng', 'Giao hàng tiết kiệm (Vận chuyển thường)', 'finish');
...
INSERT INTO `pictures` (`id_picture`, `picture`, `id_product`) VALUES
(1, '9.jpg', 1),
(2, '10.jpg', 1),
(3, '11.jpg', 1),
(4, '12.jpg', 1),
...
INSERT INTO `producers` (`id_producer`, `name`, `icon`) VALUES
(1, 'Nike', 'nike.png'),
(2, 'Adidas', 'adidas.jpg');
...
CREATE TABLE `products` (
  ...
  `thumbnail_2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `products` (`id_product`, `id_category`, `id_producer`, `name`, `description`, `price`, `id_picture`, `thumbnail`, `thumbnail_2`, `inventory`) VALUES
(1, 1, 2, 'Adidas EQT Cushion ADV \"North America\"', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p>\r\n<ul>\r\n<li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li>\r\n<li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li>\r\n<li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li>\r\n<li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li>\r\n<li>Di chuyển dễ dàng, thoải mái.</li>\r\n<li>Đế bằng chất liệu cao su<br></li>\r\n<li>Êm ái, độ bám tốt, chống trơn trượt.</li>\r\n</ul>', 7000000, 1, '801740_1_e4adfa6d09b7468a8c9fb21bf8e02bd4_medium (1).jpg', 'shoes fade 1.jpg', 10),
(2, 1, 2, 'Adidas Nmd R1 \"Villa Exclusive\"', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p>\r\n<ul>\r\n<li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li>\r\n<li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li>\r\n<li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li>\r\n<li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li>\r\n<li>Di chuyển dễ dàng, thoải mái.</li>\r\n<li>Đế bằng chất liệu cao su<br></li>\r\n<li>Êm ái, độ bám tốt, chống trơn trượt.</li>\r\n</ul>', 7000000, 2, '201493_1_017364c87c3e4802a8cda5259e3d5a95_grande.jpg', 'shoes fade 2.jpg', 10),
(3, 1, 2, 'Adidas PW Solar HU NMD \"Inspiration Pack\"', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p>\r\n<ul>\r\n<li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li>\r\n<li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li>\r\n<li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li>\r\n<li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li>\r\n<li>Di chuyển dễ dàng, thoải mái.</li>\r\n<li>Đế bằng chất liệu cao su<br></li>\r\n<li>Êm ái, độ bám tốt, chống trơn trượt.</li>\r\n</ul>', 5000000, 3, '805266_02_b8b2cdd1782246febf8879a44a7e5021_grande.jpg', 'shoes fade 3.jpg', 10),
(4, 1, 2, 'Adidas Ultraboost W', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p>\r\n<ul>\r\n<li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li>\r\n<li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li>\r\n<li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li>\r\n<li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li>\r\n<li>Di chuyển dễ dàng, thoải mái.</li>\r\n<li>Đế bằng chất liệu cao su<br></li>\r\n<li>Êm ái, độ bám tốt, chống trơn trượt.</li>\r\n</ul>', 5300000, 4, '801432_01_b16d089f8bda434bacfe4620e8480be1_grande.jpg', 'shoes fade 4.jpg', 10),
(5, 1, 2, 'Adidas Yeezy boost 350 v2 \"zebra\"', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p>\r\n<ul>\r\n<li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li>\r\n<li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li>\r\n<li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li>\r\n<li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li>\r\n<li>Di chuyển dễ dàng, thoải mái.</li>\r\n<li>Đế bằng chất liệu cao su<br></li>\r\n<li>Êm ái, độ bám tốt, chống trơn trượt.</li>\r\n</ul>', 6000000, 5, '800502_01_e92c3b2bb8764b52a791846d84a3a360_grande.jpg', 'shoes fade 5.jpg', 10),
(6, 1, 2, 'Adidas Yeezy Boost 700 \"Wave Runner\"', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p> <ul> <li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li> <li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li> <li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li> <li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li> <li>Di chuyển dễ dàng, thoải mái.</li> <li>Đế bằng chất liệu cao su<br></li> <li>Êm ái, độ bám tốt, chống trơn trượt.</li> </ul>', 6800000, 6, '802501_01_eccb69b5bcdf4ef5b209557ec6547774_grande.jpg', 'shoes fade 6.jpg', 10),
(7, 1, 2, 'Adidas Zx 4000 4d', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p> <ul> <li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li> <li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li> <li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li> <li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li> <li>Di chuyển dễ dàng, thoải mái.</li> <li>Đế bằng chất liệu cao su<br></li> <li>Êm ái, độ bám tốt, chống trơn trượt.</li> </ul>', 6400000, 7, '806859_01_1ad7dd36e7b5403286b95a253e00718d_grande.jpg', 'shoes fade 7.jpg', 10),
(8, 1, 2, 'Ultra Boost', '<p><span>Hiện đại và thời trang khi diện item mới của Nike. Màu sắc lạ mắt, chất liệu thoáng mát, nhẹ nhàng, phù hợp với những chàng trai yêu phong cách sports.</span><br><br></p> <ul> <li>Chất liệu cao cấp EVA, PU, Cushlon, Phylon.</li> <li>Bền, chống bám bẩn, dễ dàng lau chùi. Mũi giày đầy đặn, form dáng chuẩn.</li> <li>Bảo vệ đầu ngón chân khi hoạt động. Có lớp lót đệm bên trong.</li> <li>Êm, di chuyển nhiều không bị đau chân. Cổ giày thiết kế đơn giản, vừa vặn.</li> <li>Di chuyển dễ dàng, thoải mái.</li> <li>Đế bằng chất liệu cao su<br></li> <li>Êm ái, độ bám tốt, chống trơn trượt.</li> </ul>', 4700000, 8, '805338_01_eb7365e97d3f471d872159918a8526a9_grande.jpg', 'shoes fade 8.jpg', 10);
...
INSERT INTO `province` (`id_province`, `name`, `type`) VALUES
...
INSERT INTO `users` (`id_user`, `firstname`, `lastname`, `email`, `password`, `address`, `phone`) VALUES
(1, 'Vũ', 'Nguyễn Anh', 'khachhang1@gmail.com', '12345', '22 Lê Đại Hành', '0362612183'),
(2, 'Hoàng', 'Lê Nguyễn Việt', 'khachhang2@gmail.com', '12345', '07 HaRa', '0362514478');
...
ALTER TABLE `admin`
  ...
  ADD KEY `_FK_admin_province` (`province`),
  ADD KEY `_FK_admin_district` (`district`);
...
ALTER TABLE `color`
  ...
  ADD KEY `_FK_color_product` (`id_product`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `_FK_order_product` (`id_product`),
  ADD KEY `_FK_order_user` (`id_user`),
  ADD KEY `_FK_order_province` (`province`),
  ADD KEY `_FK_order_district` (`district`);
...
ALTER TABLE `order_details`
  ...
  ADD KEY `_FK_detail_product` (`id_product`);
...
ALTER TABLE `pictures`
  ...
  ADD KEY `_FK_picture_product` (`id_product`);
...
ALTER TABLE `products`
  ...
  ADD KEY `_FK_product_category` (`id_category`),
  ADD KEY `_FK_product_producer` (`id_producer`),
  ADD KEY `_FK_product_picture` (`id_picture`);
...
ALTER TABLE `size`
  ...
  ADD KEY `_FK_size_product` (`id_product`);
...
--
ALTER TABLE `admin`
  MODIFY `id_ad` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `pictures`
  MODIFY `id_picture` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `color`
  ADD CONSTRAINT `_FK_color_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `district`
--
ALTER TABLE `district`
  ADD CONSTRAINT `_FK_district_province` FOREIGN KEY (`id_province`) REFERENCES `province` (`id_province`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `_FK_order_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `_FK_order_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `order_details`
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `_FK_detail_order` FOREIGN KEY (`id_order`) REFERENCES `orders` (`id_order`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `_FK_detail_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `pictures`
--
ALTER TABLE `pictures`
  ADD CONSTRAINT `_FK_picture_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `_FK_product_category` FOREIGN KEY (`id_category`) REFERENCES `category` (`id_category`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `_FK_product_producer` FOREIGN KEY (`id_producer`) REFERENCES `producers` (`id_producer`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `size`
--
ALTER TABLE `size`
  ADD CONSTRAINT `_FK_size_product` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
